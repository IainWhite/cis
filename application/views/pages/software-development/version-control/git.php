<div class="row">
    <div class="col-lg-12 col-md-12">
        <?php echo $this->stencil->setHeadline('Git'); ?>
        <p><strong>Git</strong> is a distributed revision control and source code management system with an emphasis on speed.</p>
        <p>Git was initially designed and developed by <?php echo $this->stencil->addLink('Linus Torvalds', 'P'); ?> for Linux kernel development in 2005.</p>
