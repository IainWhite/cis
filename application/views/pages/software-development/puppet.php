<div class="row">
    <div class="col-lg-12 col-md-12">
        ...
        <p>It runs on many <?php echo $this->stencil->addLink('Unix', 'OS'); ?>-like systems as well as on <?php echo $this->stencil->addLink('Microsoft Windows', 'OS'); ?>, and includes its own declarative language to describe system configuration.</p>
