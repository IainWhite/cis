<div class="row">
    <div class="col-lg-12 col-md-12">
        ...
        <h2>I have been a <strong>Certified Scrum Master</strong> since November 2013.</h2>
        ...
        <h3>I was the Scrum Master / Project Manager for <?php echo $this->stencil->elapsedYears('10/08/2015',TRUE, TRUE, '10/02/2016'); ?> at XVT Solutions.</h3>

        <p>I identified project risks and planned with appropriate people to resolve them.</p>
        <p>I facilitated the Scrum meetings including Sprint Planning, Sprint Review, Sprint Retrospective and Daily Stand-up.</p>
        <p>I maintained the Product Backlog, Sprint Backlog and Burn Downs in Jira Agile.</p>
        ...
        <p>I was a key player in introducing Scrum to the company, simplifying the team's work-flow and using Jira Greenhopper as a Scrum board.</p>
        ...
        <p>I have a proven record of delivering project on time and within budget often exceeding client expectations.</p>
