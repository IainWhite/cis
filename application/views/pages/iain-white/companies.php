<div class="row">
    <div class="col-lg-12 col-md-12">
        ...
        <ul>
            <li><?php echo $this->stencil->addLink('XVT Solutions', 'iain-white/companies'); ?>, Brisbane AU, 2015 - 2015</li>
            <li><?php echo $this->stencil->addLink('Creative Intersection', 'iain-white/companies'); ?>, Brisbane AU, 2015 - 2015</li>
            ...
            <li><?php echo $this->stencil->addLink('TigerRedi', 'iain-white/companies'); ?>, Bristol UK, 2000 - 2001</li>
