<div class="funny-boxes funny-boxes-left-green shadow-effect-1 rounded-2x">
    ...
    <ul>
        <li>Managing the day to day running of the web development team for www.onthehouse.com.au.</li>
        <li>Team Leader / Scrum Master / Project Manager / Technical Lead.</li>
        <li>Provide solutions with an agile development environment.</li>
        <li>Enforcing and improving the tools, systems and methodologies used within the department.</li>
        <li>Leading by example, training and mentoring developers and testers.</li>
        <li>Producing clean, well-written and effective PHP OOP code with an eye towards optimization.</li>
        <li>Ensuring that assigned deliverables are produced on schedule to the appropriate level of quality.</li>
        <li>Working closely with team members, QA and Support to resolve issues that are found.</li>
        <li>Defining the overall software architecture and solution designs.</li>
        <li>Pro-actively identifying areas of risk, and where improvements can be made to improve quality and efficiency.</li>
    </ul>
</div>