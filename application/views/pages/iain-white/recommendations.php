...
<div class="row">
    <div class="col-lg-6 col-md-6">
        <div class="speechbubble rounded-2x">
        ...
        <p class="speechbubble-author">Tim Bland, Senior Systems Analyst, The AOT Group</p>
    </div>
    <div class="col-lg-6 col-md-6">
        <div class="speechbubble rounded-2x">
        ...
        <p class="speechbubble-author">Anthoney Woodyard, General Manager - Distribution Systems, The AOT Group</p>
    </div>
</div>
...
<div class="row">
    <div class="col-lg-12 col-md-12">
        ...
        <p class="speechbubble-author">Darren Earny, Business Development and Operations Director, JPC Infonet</p>
    </div>
</div>
...
<div class="row">
    <div class="col-lg-6 col-md-6">
        ...
        <p class="speechbubble-author">Kevin Haynes, Director, TigerRedi</p>
    </div>
    <div class="col-lg-6 col-md-6">
        <div class="speechbubble rounded-2x">
        ...
        <p class="speechbubble-author">Ben Saul, Creative Director, TigerRedi</p>
    </div>
</div>
...
<div class="row">
    <div class="col-lg-12 col-md-12">
        ...
        <p class="speechbubble-author">Ray F. Levett, Manager, Technical Systems Development, Airbus Computing</p>
    </div>
</div>