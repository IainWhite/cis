<div class="row">
    <div class="col-lg-12 col-md-12">
        <?php echo $this->stencil->setHeadline('SSI - Server Side Includes'); ?>
        ...
        <p>The simple design of the language makes it easier to learn and use than most <?php echo $this->stencil->addLink('server-side scripting', 'WD'); ?> languages, while complicated server-side processing is often done with one of the more feature-rich programming languages.</p>
        <p>SSI is Turing complete.</p>
        <p><?php echo $this->stencil->addLink('Apache', 'WS'); ?>, <?php echo $this->stencil->addLink('Nginx', 'WS'); ?>, <?php echo $this->stencil->addLink('lighttpd', 'WS'); ?> and <?php echo $this->stencil->addLink('IIS', 'WS'); ?> are the four major web servers that support this language.</p>
