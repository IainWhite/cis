<div class="row">
    <div class="col-lg-12 col-md-12">
        <?php echo $this->stencil->setHeadline('Cherokee Web Server'); ?>
        <p><strong>Cherokee</strong> is an open-source cross-platform web server that runs on <?php echo $this->stencil->addLink('Linux', 'OS'); ?>, <?php echo $this->stencil->addLink('BSD', 'OS'); ?> variants, <?php echo $this->stencil->addLink('Solaris', 'OS'); ?>, <?php echo $this->stencil->addLink('Mac OS X', 'OS'); ?>, and <?php echo $this->stencil->addLink('Microsoft Windows', 'OS'); ?>.</p>
