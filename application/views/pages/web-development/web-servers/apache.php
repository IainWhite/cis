<div class="row">
    <div class="col-lg-12 col-md-12">
        <?php echo $this->stencil->setHeadline('Apache HTTP Server'); ?>
        <p>The <strong>Apache</strong> HTTP Server, is a web server application notable for playing a key role in the initial growth of the <?php echo $this->stencil->addLink('World Wide Web', 'WD'); ?>.</p>
        ...
        <p>Apache is developed and maintained by an open community of developers under the auspices of the <?php echo $this->stencil->addLink('Apache Software Foundation', 'C'); ?>.</p>
