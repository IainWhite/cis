<div class="row">
    <div class="col-lg-12 col-md-12">
        <?php echo $this->stencil->setHeadline('Vi'); ?>
        <p><strong>Vi</strong> is a screen-oriented text editor originally created for the <?php echo $this->stencil->addLink('Unix', 'OS'); ?> operating system. The portable subset of the behavior of vi and programs based on it, and the <strong>ex</strong> editor language supported within these programs.</p>
        <p>The original code for vi was written by <strong>Bill Joy</strong> in 1976, as the visual mode for a line editor called ex that Joy had written with Chuck Haley. Bill Joy's ex 1.1 was released as part of the first BSD Unix release in March, 1978. It was not until version 2.0 of ex, released as part of Second Berkeley Software Distribution in May, 1979 that the editor was installed under the name vi (which took users straight into ex's visual mode), and the name by which it is known today.</p>
