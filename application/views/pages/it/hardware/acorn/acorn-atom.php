<div class="row">
    <div class="col-lg-12 col-md-12">
        <?php echo $this->stencil->setHeadline('Acorn Atom'); ?>
        <p>The <strong>Acorn Atom</strong> was a home computer made by <?php echo $this->stencil->addLink('Acorn Computers Ltd', 'C'); ?> from 1980 to 1982 when it was replaced by the <?php echo $this->stencil->addLink('BBC Micro', 'ITH'); ?> (originally called the <em>Proton</em>).</p>
        <p>The Atom was a progression of the <?php echo $this->stencil->addLink('MOS Technology 6502', 'CPU'); ?> based machines that the company had been making from 1979.</p>
