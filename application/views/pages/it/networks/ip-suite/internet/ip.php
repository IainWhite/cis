<div class="row">
    <div class="col-lg-12 col-md-12">
        <?php echo $this->stencil->setHeadline('IP - Internet Protocol'); ?>
        <p>The <strong>Internet Protocol</strong> (<strong>IP</strong>) is the principal communications protocol in the <?php echo $this->stencil->addLink('Internet Protocol Suite', 'ITN'); ?> for relaying datagrams across network boundaries.</p>
        <p>Its routing function enables internetworking, and essentially establishes the Internet.</p>
        <p>IP, as the primary protocol in the <?php echo $this->stencil->addLink('Internet Layer', 'IPS'); ?> of the Internet protocol suite, has the task of delivering packets from the source host to the destination host solely based on the IP addresses in the packet headers.</p>
