<div class="row">
    <div class="col-lg-12 col-md-12">
        ...
        <p>HTTP functions as a request-response protocol in the <?php echo $this->stencil->addLink('client-server', '/it/networks'); ?> computing model.</p>
        ...
        <p>The server, which provides resources such as <?php echo $this->stencil->addLink('HTML', 'WD'); ?> files and other content, or performs other functions on behalf of the client, returns a response message to the client.</p>
        ...
        <p>HTTP is an <?php echo $this->stencil->addLink('Application Layer', '/it/networks/internet-protocol-suite'); ?> protocol designed within the framework of the <?php echo $this->stencil->addLink('Internet Protocol Suite', '/it/networks'); ?>.</p>
        <p>Its definition presumes an underlying and reliable <?php echo $this->stencil->addLink('Transport Layer', '/it/networks/internet-protocol-suite'); ?> protocol, and <strong>Transmission Control Protocol</strong> (<?php echo $this->stencil->addLink('TCP', '/it/networks/internet-protocol-suite/transfer'); ?>) is commonly used.</p>
        <p>However HTTP can use unreliable protocols such as the <strong>User Datagram Protocol</strong> (<?php echo $this->stencil->addLink('UDP', '/it/networks/internet-protocol-suite/transfer'); ?>), for example in <strong>Simple Service Discovery Protocol</strong> (SSDP).</p>
        ...
        <p>URIs and hyperlinks in <strong>Hypertext Mark-up Language</strong> (<?php echo $this->stencil->addLink('HTML', 'WD'); ?>) documents form webs of inter-linked hypertext documents.</p>
