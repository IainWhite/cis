<div class="row">
    <div class="col-lg-12 col-md-12">
        <?php echo $this->stencil->setHeadline("Linus's Law"); ?>
        <p>There are two statements named <strong>Linus's Law</strong>: one by <?php echo $this->stencil->addLink('Eric S. Raymond', '/people'); ?> concerning software bug detection by a community, and the other by <?php echo $this->stencil->addLink('Linus Torvalds', '/people'); ?> about the motivations of programmers.</p>

        <h2>Eric Raymond</h2>
        <p>Linus's Law as described by Raymond is a claim about software development, named in honor of <?php echo $this->stencil->addLink('Linus Torvalds', '/people'); ?> and formulated by Raymond in his essay and book "<?php echo $this->stencil->addLink('The Cathedral and the Bazaar', '/books'); ?>" (1999).</p>
