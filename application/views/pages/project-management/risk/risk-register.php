<div class="row">
    <div class="col-lg-12 col-md-12">
        <?php echo $this->stencil->setHeadline('Risk Register'); ?>
        <p>A <strong>risk register</strong> is a <?php echo $this->stencil->addLink('risk management', 'PMR'); ?> tool commonly used in risk management and compliance . It acts as a central repository for all risks identified by the organisation and, for each risk, includes information such as source, nature, treatment option, existing counter-measures, recommended counter-measures and so on. It can sometimes be referred to as a <strong>risk log</strong> (for example in <?php echo $this->stencil->addLink('PRINCE2', 'PMM'); ?>).</p>
        <p>A wide range of suggested contents for a risk register exist and recommendations are made by the <strong>Project Management Institute Body of Knowledge</strong> (<?php echo $this->stencil->addLink('PMBOK', 'PM'); ?>) and <?php echo $this->stencil->addLink('PRINCE2', 'PMM'); ?> among others. In addition many companies provide software tools that act as risk registers. Typically a risk register contains:</p>
        <ul>
