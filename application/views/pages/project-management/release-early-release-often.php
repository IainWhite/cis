<div class="row">
    <div class="col-lg-12 col-md-12">
        <?php echo $this->stencil->setHeadline('Release Early, Release Often'); ?>
        ...
        <p>This philosophy was popularized by <strong>Eric S. Raymond</strong> in his 1997 essay <?php echo $this->stencil->addLink('The Cathedral and the Bazaar', 'B'); ?>, where Raymond stated <em>"Release early. Release often. And listen to your customers"</em>.</p>
        <p>This philosophy was originally applied to the development of the <?php echo $this->stencil->addLink('Linux', 'OS'); ?> kernel and other open-source software, but has also been applied to closed source, commercial software development.</p>
