<div class="row">
    <div class="col-lg-12 col-md-12">
        ...
        <p>Rapid application development is a response to processes developed in the 1970s and 1980s, such as the <?php echo $this->stencil->addLink('Structured Systems Analysis and Design Method', 'PMM'); ?> (SSADM) and other <?php echo $this->stencil->addLink('Waterfall', 'PMM'); ?> models.</p>
...
<?php if (!$this->stencil->getIsSub()): ?>
    <div class="row">
        <div class="col-lg-12 col-md-12">
            ...
            <ol>
                <li><strong>Requirements Planning phase</strong> - combines elements of the system planning and systems analysis phases of the <?php echo $this->stencil->addLink('Systems Development Life Cycle', 'PMM'); ?> (SDLC). Users, managers, and IT staff members discuss and agree on business needs, project scope, constraints, and system requirements. It ends when the team agrees on the key issues and obtains management authorization to continue.</li>
