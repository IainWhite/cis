<div class="row">
    <div class="col-lg-12 col-md-12">
        ...
        <p>Product Scope is the features and functions that characterize a product, service, or result.</p>
        <p>Notice that Project Scope is more work-oriented, (<em>the hows</em>) while Product Scope is more oriented toward functional requirements. (<em>the whats</em>)</p>
        <p>If requirements aren't completely defined and described and if there is no effective change control in a project, <?php echo $this->stencil->addLink('scope creep', 'PM'); ?> may ensue.</p>
    </div>
</div>