<div class="row">
    <div class="col-lg-12 col-md-12">
        <?php echo $this->stencil->setHeadline('Agile Software Development'); ?>
        <?php echo $this->stencil->addImage('Agile Methodology', 'jpg', 'left'); ?>
        <p><strong>Agile software development</strong> is a group of software development methods based on iterative and incremental development, where requirements and solutions evolve through collaboration between self organizing, cross functional teams.</p>
