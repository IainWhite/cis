<div class="row">
    <div class="col-lg-12 col-md-12">
        ...
        <p><?php echo $this->stencil->addLink('Scrum', 'PMA'); ?> is facilitated by a <strong>Scrum Master</strong>, who is accountable for removing impediments to the ability of the team to deliver the sprint goal / deliverables.</p>
