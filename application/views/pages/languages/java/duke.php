<div class="row">
    <div class="col-lg-12 col-md-12">
        <?php echo $this->stencil->setHeadline('Java Mascot - Duke'); ?>
        <p>Back in the early days of <?php echo $this->stencil->addLink('Java', 'L'); ?> development, Sun Microsystems’ Green Project team created its first working demo-an interactive handheld home entertainment controller called the Star7. At the heart of the animated touch-screen user interface was a cartoon character named Duke.</p>
