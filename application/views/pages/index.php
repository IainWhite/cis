...
<div class="row">
    ...
    <div class="col-md-12">
        ...
        <p>The <strong>Systems Development Life Cycle (SDLC)</strong> is one example of a methodology for guiding the project management process from an initial feasibility study through maintenance of the completed application. Various SDLC approaches include the waterfall model</strong>, which was the original SDLC method, <strong>Rapid Application Development (RAD)</strong>, <strong>Joint Application Development (JAD)</strong>, the <strong>Fountain Model</strong>, the <strong>Spiral model</strong>, build and fix; and synchronize and stabilize. A number of charting methods, such as the <strong>Gantt chart</strong> and <strong>PERT chart</strong> have been developed as tools to create a graphic representation of a project plan and its current status.</p>
